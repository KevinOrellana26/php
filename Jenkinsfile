pipeline {
    ...
    parameters {
        ...
        string(name: 'NODE_NAMESPACE', defaultValue: params.NODE_NAMESPACE ?: 'php', description: 'Namespace for PHP')

        string(name: 'EKS_CLUSTER_NAME', defaultValue: params.EKS_CLUSTER_NAME ?: 'infra-syndeno', description: 'Cluster Name')
    }
